...
\end{align*}
and the rest of the $U_j=H$.  We can then use the circuit to graph construction from \chap{SP_ground} to construct a simple graph with the ground space spanned by the history states of this circuit.  
