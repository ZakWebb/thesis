...
\todo{maybe make a picture of this?}
...
Since the energy corresponding to momentum $-\frac{\pi}{2}$ is zero, the eigenvalue equations for this gadget are slightly easier than average to manipulate.  Additionally, this was the momentum used in \cite{FGG07} in their algorithm for the AND-OR tree.
...
\begin{figure}
  ...
  \caption{Two gates that implement an encoded Hadamard at $-\frac{\pi}{4}$.  \subfig{pi_2_had}  A simple gate.  \subfig{pi_2_had_planar}  More complicated but planar gate.}
...
\begin{figure}
  ...
  \caption{Graph implementing a non-Clifford gate at $k = -\frac{\pi}{2}$.
...
\begin{figure}
  ...
  \caption{A non-clifford gate used for universal computation at $-\frac{\pi}{3}$ and $-\frac{2\pi}{3}$.}
...
\subsection{Other momenta}

While the previous sections have given us nice
