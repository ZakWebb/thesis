...
%           to (3.25,.45) to (3.45,.45);
  ...
  \draw[|-|] (-2,-.8)   to node[below] {$\alpha\mu$} (0.25,-.8);
  \draw[|-|] (0.25,-.8) to node[below] {$2L$}   (2.25,-.8);
  \draw[|-|] (2.25,-.8) to node[below] {$\mu - L$} (4.5,-.8); 

  \draw[|-|] (5.5,-.8) to node[below] {$K$} (12,-.8);
...
\begin{scope}[xshift=4cm]
 ...
 \foreach \yshift in {.5,-.1}{
   \begin{scope}[yshift=\yshift cm,xshift = 19.5cm,yscale = .05,xscale = .3333]
  \begin{axis}[every axis plot post/.append style={
    mark=none,domain=-3:3,samples=50,smooth}, % All plots: from -2:2, 50 samples, smooth, no marks
    axis lines = none] 
    \addplot[color=black]{gauss(0,.75)};
...
%  \draw[xshift=1cm] (18.55,.45) to (18.75,.45) to (18.75,.6)
 ...
 % \draw[xshift=1cm] (18.55,-.1) to (18.75,-.1) to (18.75,.05)
  ...
  \draw[|-|] (10,-.8) to node[below] {$K$} (16.5,-.8);
  \draw[|-|] (17.5,-.8) to node[below] {$\mu-L$} (19.75,-.8);
  \draw[|-|] (19.75,-.8) to node[below] {$2L$} (21.75,-.8);
  \draw[|-|] (21.75,-.8) to node[below] {$\alpha\mu$} (24,-.8);
