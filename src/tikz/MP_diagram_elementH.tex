...
% Output nodes change for each type 
   \node[left] at (3.24,1.66) {\footnotesize $(0,4k+3)$}; 
   \node[left] at (3.24,1.33) {\footnotesize $(0,5k+3)$};
   \node[left] at (3.24,.66) {\footnotesize $(1,6k+3)$}; 
   \node[left] at (3.24,.33) {\footnotesize $(1,7k+3)$};  
%}   
  % Type of Graph
  \node at (1.62,2.5) {\huge $H$};   
\end{tikzpicture} 