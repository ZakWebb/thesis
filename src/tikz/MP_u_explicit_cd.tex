\begin{tikzpicture} [scale=1.5,
 ...
 \end{scope}}
  ...
  \node at (3.5,0) [below] {};
  \node at (4.5,0) [below] {};
  \node at (6,0) [below] {($2X\!+\! Z$,4)};
  \node at (8,0) [below] {($2X\! +\! Z\! +\! 2$,4)};
  ...
  \node at (6,3.5) [above] {($2W\! + \! Z$,1)};
  \node at (8,3.5) [above] {($2W\! + \! Z\! + \! 2$,1)};
  ...
  \node at (8,.5) [above] {($2W\! + \! Z\! + \! 2$,2)};
  \node at (6,.5) [above] {($2W\! + \! Z$,2)};
  \node at (4.13,.5) [below right] {($W\! + \! Z\! + \! 3$,2)};  
  
  \node at (8,3) [below] {($2X\! + \! Z\! + \! 2$,3)};
  \node at (6,3) [below] {($2X\! + \! Z$,3)};
  \node at (4.13,3) [above right] {($X\! + \! Z\! + \! 3$,3)};
  ...
  \node at (-.4,0) [left] {$0_{2,\text{in}}$};
  \node at (-.4,.5) [left] {$1_{2,\text{in}}$};
  \node at (-.4,3) [left] {$1_{1,\text{in}}$};
  \node at (-.4,3.5) [left] {$0_{1,\text{in}}$};
  
  \node at (8.7,0) [right] {$0_{2,\text{out}}$};
  \node at (8.7,.5) [right] {$1_{1,\text{out}}$};
  \node at (8.7,3) [right] {$1_{2,\text{out}}$};
  \node at (8.7,3.5) [right] {$0_{1,\text{out}}$};
\end{tikzpicture}